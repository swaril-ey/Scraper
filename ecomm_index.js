...
(async () => {
 ...
 // const browser = await puppeteer.launch({ headless: false, args: ['--disable-extensions-except=/Users/swarilparikh/Library/Application Support/Google/Chrome/Default/Extensions/idgpnmonknjnojddfkpgkljpfnnfcklj/6.0.3_0/'] });
 ...
 const page = await browser.newPage();
  ...
  await page.setExtraHTTPHeaders({
    'X-Forwarded-For': '140.82.201.200'
  })

  await page.goto(
    `https://claudiaximenaramirez.stg01-herbalife.com/${locale}/u/category/all-products`
  )
  ...
  for (let i = 0; i < urls.length; i++) {
    ...
    await page.goto('https://claudiaximenaramirez.stg01-herbalife.com' + url);
